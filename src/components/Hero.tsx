...
export function Hero() {
  ...
  return (
    <section id="top" className="relative flex min-h-[100svh] items-center overflow-hidden bg-hero pb-20 pt-28 sm:pb-24 sm:pt-36">
      ...
      <div 
        className="absolute -right-20 top-20 pointer-events-none -z-10 opacity-[0.04] rotate-[15deg] hidden lg:block"
        style={{ width: "600px" }}
      >
      ...
      <div 
        className="absolute -left-20 bottom-0 pointer-events-none -z-10 opacity-[0.03] -rotate-[10deg] hidden lg:block"
        style={{ width: "400px" }}
      >
        <img src={logoIcon} alt="" className="w-full h-auto grayscale" />
      </div>
