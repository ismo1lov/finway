...
const dict = {
  uz: {
    ...
    "services.eyebrow": "Bizning",
    "services.eyebrow.accent": "Xizmatlar",
    "services.subtitle": "Sizning biznesingiz uchun professional buxgalteriya yechimlari.",
    "service.1.title": "Buxgalteriya hisobi",
    "service.1.desc": "Barcha turdagi korxonalar uchun to'liq buxgalteriya xizmati.",
    "service.2.title": "Soliq maslahati",
    "service.2.desc": "Soliqlarni optimallashtirish va qonuniy maslahatlar.",
    "service.3.title": "1C Dasturi",
    "service.3.desc": "1C dasturini o'rnatish va hisobni avtomatlashtirish.",
    "service.4.title": "Audit xizmati",
    "service.4.desc": "Moliyaviy hujjatlarni tekshirish va xatolarni tuzatish.",
    "service.5.title": "Kadrlar hisobi",
    "service.5.desc": "Xodimlar bilan bog'liq barcha hujjat ishlarini yuritish.",
    "service.6.title": "Biznes konsalting",
    "service.6.desc": "Biznesni rivojlantirish bo'yicha moliyaviy strategiyalar.",
    "about.eyebrow": "Biz haqimizda",
    "about.title": "Nega aynan Finway?",
    "about.body": "Bizning o'quv markazimiz 10 yildan ortiq tajribaga ega mutaxassislar tomonidan tashkil etilgan. Biz nafaqat o'qitamiz, balki professional kadrlar tayyorlaymiz.",
    "about.point.1": "Amaliy darslar",
    "about.point.2": "Xalqaro sertifikat",
    "about.point.3": "Ishga joylashish",
    "about.point.4": "Mentorlik tizimi",
  },
} as const;
